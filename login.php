...
<head>
    ...
    <link rel="stylesheet" href="/pay_css/login.css">
    ...
    <div class="form">
        ...
        <div id="form">
            <div class="txt_field">
                ...
                <span></span>
                <label class="label-one"><i class="fa-sharp fa-solid fa-user"></i> Username</label>
            </div>
            <div class="txt_field">
            ...
            <button type="submit" id="user" value="login">Submit</button>
...
<script src="/pay_js/login.js"></script>
</html>